CustomizableWeaponry:addFireSound("CW_MP7_OFFICIAL_FIRE", "weapons/cw_mp7_official/fire_unsuppressed.wav", 1, 113, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_MP7_OFFICIAL_FIRE_SUPPRESSED", "weapons/cw_mp7_official/fire_suppressed.wav", 1, 90, CHAN_STATIC)
